...
class Args:
    ...
    def parse(self, words):
        ...
        if command == SAVED_PORTFOLIO[1]:
            ...
            return RSP_INVALID_PARAMETERS % words

    def is_list(self) -> bool:
        return self.list == SAVED_PORTFOLIO[2]

    def is_select(self) -> bool:
        return self.select == SAVED_PORTFOLIO[3] and len(self.name) > 0

    def is_current(self) -> bool:
        return self.current == SAVED_PORTFOLIO[4]

    def is_save(self) -> bool:
        return self.save == SAVED_PORTFOLIO[5] and len(self.id) > 0 and len(self.name) > 0

    def is_add(self) -> bool:
        return self.add == SAVED_PORTFOLIO[6] and len(self.stock) > 0 and len(self.lot) > 0 and len(self.price) > 0

    def is_rm(self) -> bool:
        return self.rm == SAVED_PORTFOLIO[7] and len(self.stock) > 0 and len(self.lot) > 0

    def is_stat(self) -> bool:
        return self.stat == SAVED_PORTFOLIO[8]

    def is_compare(self) -> bool:
        return self.compare == SAVED_PORTFOLIO[9] and len(self.name) > 0
